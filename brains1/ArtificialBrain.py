...
class ArtificialAgentBrain(AgentBrain):
    ...
    def __init__(self,memorize_for_ticks=None):
        ...
        * :meth:`matrx.agents.agent_brain.get_log_data`
        ...
        # Filled by the WorldBuilder during self.factory_initialise()
        self.agent_id = None
    ...
    def initialize(self):
        ...
        a world builder, you only pass the class of your agent brain, not the
    ...
    def filter_observations(self, state):
        ...
        also fed through the MATRX API to any vizualisations.
    ...
    def _factory_initialise(self, agent_name, agent_id, action_set, sense_capability, agent_properties,
        ...
        self.keys_of_agent_writable_props = customizable_properties if customizable_properties is not None else []
